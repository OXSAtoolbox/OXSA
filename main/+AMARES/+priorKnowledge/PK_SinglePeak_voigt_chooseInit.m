function outStruct = PK_SinglePeak_voigt_chooseInit(chemShift,amplitude,linewidth,phase,sigma)
...
values.IVCellArray = {...
'Peak1',                                        chemShift,               linewidth,         amplitude,               phase, sigma;
};
...
outStruct.svnHeader = '$Header: https://cardiosvn.fmrib.ox.ac.uk/repos/crodgers/FromJalapeno/MATLAB/RodgersSpectroToolsV2/main/+AMARES/+priorKnowledge/PK_SinglePeak_voigt_chooseInit.m 11952 2018-03-21 15:54:46Z lucian $';
