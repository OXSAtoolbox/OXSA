...
[coldata,rowdata]=ndgrid((0:obj.columns)*obj.pixelSpacing(2), ...
                         (0:obj.rows   )*obj.pixelSpacing(1));
...
fulldata(:,:,:,1) = fulldata(:,:,:,1) + repmat(0.5*obj.sliceThickness*obj.sliceNormal,[1,obj.columns+1,obj.rows+1,1]);
fulldata(:,:,:,2) = fulldata(:,:,:,2) - repmat(0.5*obj.sliceThickness*obj.sliceNormal,[1,obj.columns+1,obj.rows+1,1]);
end
