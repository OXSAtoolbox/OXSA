function [fulldata] = calcVoxelInPlaneVertexCoordsForSlice(obj, slice)
% Calculate coordinates of the vertices of the pixels in the image plane
% using the DICOM coordinate system for the specified slice.
%
