...
% Convert Hue-Saturation-Luminance Color value to Red-Green-Blue Color value
% 
% Usage
%       RGB = hsl2rgb(HSL)
%
...
% Suresh E Joel, 26 Apr 2003.
% Chris Rodgers, 27 May 2011.
...
if ~isempty(hsl) && (max(hsl(:)) > 1 || min(hsl(:)) < 0)
